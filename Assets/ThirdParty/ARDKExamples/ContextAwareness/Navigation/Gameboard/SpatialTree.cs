...
namespace Niantic.ARDKExamples.Gameboard
{
  public partial class SpatialTree
  {
    ...
    public void Remove(IEnumerable<GridNode> gridNodes)
    {
      foreach (var gridNode in gridNodes)
      {
    ...
    /// @param setting The game board's configuration.
    public void DrawGizmos(BoardConfiguration settings)
    {
