...
namespace Niantic.ARDK.Utilities.Collections
{
  ...
  /// <remarks>
  /// <para>
  /// An instance of the <b>_ReadOnlyDictionary</b> generic class is
  ...
  internal sealed class _ReadOnlyDictionary<TKey, TValue>:
    ...
    ICollection
  {
    ...
    /// <see cref="T:_ReadOnlyDictionary`2" /> class that wraps
    ...
    /// <see cref="T:ARDK.Utilities.Collections._ReadOnlyDictionary`2"></see>.
    /// </summary>
    /// <value>The number of key/value pairs.</value>
    /// <returns>The number of key/value pairs contained in the
    /// <see cref="T:ARDK.Utilities.Collections._ReadOnlyDictionary`2"></see>.</returns>
    public int Count
    {
    ...
    /// <see cref="T:_ReadOnlyDictionary{TKey,TValue}"></see>.</summary>
    ...
    /// <see cref="T:ARDK.Utilities.Collections._ReadOnlyDictionary`2"/>.
    /// </summary>
    ...
    /// <see cref="T:ARDK.Utilities.Collections._ReadOnlyDictionary`2"/>.</summary>
    /// <param name="key">
    ...
    /// <summary>Determines whether the <see cref="T:ARDK.Utilities.Collections._ReadOnlyDictionary`2" />
    /// contains the specified key.</summary>
    /// <returns>
    /// True if the <see cref="T:ARDK.Utilities.Collections._ReadOnlyDictionary`2" /> contains
    /// an element with the specified key; otherwise, false.
    /// </returns>
    /// <param name="key">The key to locate in the
    /// <see cref="T:ARDK.Utilities.Collections._ReadOnlyDictionary`2"></see>.</param>
    /// <exception cref="T:System.ArgumentNullException">
    /// Thrown when the key is null.
    /// </exception>
    ...
    /// <summary>
    /// This method is not supported by the <see cref="T:ARDK.Utilities.Collections._ReadOnlyDictionary`2"/>.
    /// </summary>
    ...
    /// <returns>
    /// <b>true</b> if the <see cref="T:ARDK.Utilities.Collections._ReadOnlyDictionary`2" /> contains
    ...
    /// <summary>This method is not supported by the
    /// <see cref="T:_ReadOnlyDictionary`2"/>.</summary>
    /// <param name="item">
  ...
  internal sealed class ReadOnlyDictionaryDebugView<TKey, TValue>
  {
    ...
    public ReadOnlyDictionaryDebugView(_ReadOnlyDictionary<TKey, TValue> dictionary)
    {
      if (dictionary == null)
